    ...
    public List<Deposit> initDeposits(String FILEPATH) {
        ...
        try {
            ...
            for (Deposit deposit : depositList) {
                Pair<Boolean, String> validation = InputValidators.validator(deposit);

                if (validation.getKey()) {
                    switch (deposit.getDepositType()) {
                        case Strings.LONG_TERM:
                            Deposit longDeposit = new LongDeposit(
                        ...
                        case Strings.LOAN:
                            ...
                            break;
                        default:
                            System.out.println(Strings.CHECK_DEPOSIT + deposit.getDepositID());
                    }
                } else {
                    System.out.println(validation.getValue() + " " + deposit.getDepositID());
                }
            }
